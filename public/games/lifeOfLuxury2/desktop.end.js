(function() {
    ...
    preload.preload = function() {
        ...
        if (
            ...
            needUrlPath = location.href.substring(
                0,
        ...
        game.load.image(
            "game.background",
            "" + path + "/img/bg.png" + part2Url
        );
        game.load.image(
            "game.background2",
            "" + path + "/img/bg2.jpg" + part2Url
        );
        game.load.image(
            "game.background3",
            "" + path + "/img/bg3.png" + part2Url
        );
        game.load.image(
            "background2_panels",
        ...
        game.load.image(
            "multiplier",
            "" + path + "/img/Multiplier.png" + part2Url
        );
        game.load.image(
            "spins_remaining",
        ...
        game.load.image(
            "collect",
            "" + path + "/img/btns/Collect.png" + part2Url
        );
        game.load.image(
            "collect_p",
        ...
        game.load.image(
            "help_p",
            "" + path + "/img/btns/Help_p.png" + part2Url
        );
        game.load.image(
            "paytable",
        ...
        game.load.image(
            "Next_p",
            "" + path + "/img/btns/Next_p.png" + part2Url
        );
        game.load.image("Prev", "" + path + "/img/btns/Prev.png" + part2Url);
        game.load.image(
            "Prev_p",
            "" + path + "/img/btns/Prev_p.png" + part2Url
        );

        game.load.image(
            "return",
            "" + path + "/img/btns/Return.png" + part2Url
        );
        game.load.image(
            "return_p",
        ...
        game.load.image(
            "exit_p",
            "" + path + "/img/btns/Exit_p.png" + part2Url
        );
        game.load.image(
            "addCredit",
        ...
        game.load.image(
            "little_bri",
            "" + path + "/img/little_bri.png" + part2Url
        );
        game.load.image(
            "medium_bri",
            "" + path + "/img/medium_bri.png" + part2Url
        );
        game.load.image(
            "first_bri",
            "" + path + "/img/first_bri.png" + part2Url
        );
        game.load.image(
            "blue_field",
            "" + path + "/img/blue_field.png" + part2Url
        );
        ...
        game.load.audio(
            "briWin",
            needUrlPath + "/sounds/briWin.mp3" + part2Url
        );
        game.load.audio(
            "collect",
            needUrlPath + "/sounds/collect.mp3" + part2Url
        );
        game.load.audio(
            "more_pays",
        ...
        game.load.audio(
            "medium",
            needUrlPath + "/sounds/wins/medium.wav" + part2Url
        );
        game.load.audio(
            "high",
            needUrlPath + "/sounds/wins/high.wav" + part2Url
        );
        ...
        game.load.audio(
            "helpSound",
            needUrlPath + "/sounds/help.mp3" + part2Url
        );
        game.load.audio(
            "freeSpinMulti",
        ...
        game.load.audio(
            "briShow",
            needUrlPath + "/sounds/briShow.wav" + part2Url
        );
