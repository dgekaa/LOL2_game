(function() {
    ...
    preload.preload = function() {
        ...
        game.load.spritesheet('bri_anim', '' + path + '/img/bri_anim.png' + part2Url, 160, 150, 12);
        game.load.spritesheet('car_anim', '' + path + '/img/car_anim.png' + part2Url, 160, 150, 5);
        game.load.spritesheet('kater_anim', '' + path + '/img/kater_anim.png' + part2Url, 157, 149, 4);
